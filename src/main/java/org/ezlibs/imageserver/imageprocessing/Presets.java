...
public class Presets {
    ...
    private static final Dimensions SM_SQ_DIMS = new Dimensions(256, 256);
    private static final Dimensions MD_SQ_DIMS = new Dimensions(512, 512);
    private static final Dimensions LG_SQ_DIMS = new Dimensions(1024, 1024);

    // Wide image aspect ratio and sizes
    private static final Ratio WIDE_RATIO = new Ratio(16f, 9f);
    private static final Dimensions LG_WIDE_DIMS = new Dimensions(1920, 1080);
    private static final Dimensions MD_WIDE_DIMS = new Dimensions(960, 540);
    private static final Dimensions SM_WIDE_DIMS = new Dimensions(480, 270);

    // Tall image aspect ratio and sizes
    private static final Ratio TALL_RATIO = new Ratio(9f, 16f);
    private static final Dimensions LG_TALL_DIMS = new Dimensions(1080, 1920);
    private static final Dimensions MD_TALL_DIMS = new Dimensions(540, 960);
    private static final Dimensions SM_TALL_DIMS = new Dimensions(270, 480);
